...
public class Quiz extends JFrame implements ActionListener{
    ...
    String ans[][] = new String[10][1];//person answer
    String qa [][] = new String[10][2];// correct answers 
    ...
    Quiz(String username){
        ...
        next.setBounds(1100,620,200,40);
...
//Start from 42 mins in video
// Start from  1 hour in video